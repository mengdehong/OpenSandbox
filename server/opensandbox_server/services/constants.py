...
class SandboxErrorCodes:
    ...
    # fleets (fast-sandbox) runtime error codes
    FLEETS_SANDBOX_NOT_FOUND = "FLEETS::SANDBOX_NOT_FOUND"
    FLEETS_POOL_NOT_FOUND = "FLEETS::POOL_NOT_FOUND"
    FLEETS_API_ERROR = "FLEETS::API_ERROR"
    FLEETS_UNSUPPORTED = "FLEETS::API_NOT_SUPPORTED"
