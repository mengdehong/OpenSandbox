...
test("public type declarations export stable models", async () => {
  ...
  assert.match(declarations, /\bByteRange\b/);
  assert.match(declarations, /\bReadBytesResponse\b/);
  assert.match(declarations, /\bReadBytesStream\b/);
});
